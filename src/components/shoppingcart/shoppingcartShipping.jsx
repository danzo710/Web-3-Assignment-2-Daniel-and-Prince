...
const ShoppingCartShipping = () => {
  const { merchandiseSubtotal } = useCart();
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
      ...
      <div className="space-y-4">
        <div>
          <label htmlFor="shipping-method" className="block text-sm font-semibold text-gray-700 mb-2">
            Method
          </label>
          <select
            id="shipping-method"
      ...
      <p className="mt-4 font-medium text-gray-700">
        Shipping Cost: <span className="font-bold">${shippingCost.toFixed(2)}</span>
      </p>
    </div>
  );
};
